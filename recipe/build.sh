...
curl -fSsL https://github.com/coin-or-tools/ThirdParty-Metis/archive/releases/1.3.9.tar.gz | tar xz && cd ThirdParty-Metis-releases-1.3.9 && ./get.Metis && ./configure --prefix=${PREFIX} && make -j${CPU_COUNT} && make install && cd -
